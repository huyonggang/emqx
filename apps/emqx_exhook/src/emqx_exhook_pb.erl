...
-type 'valued_response.ResponsedType'() :: 'CONTINUE' | 'IGNORE' | 'STOP_AND_RETURN'.
...
-type valued_response() ::
      #{type                    => 'CONTINUE' | 'IGNORE' | 'STOP_AND_RETURN' | integer(), % = 1, enum valued_response.ResponsedType
...
dfp_read_field_def_client_info(<<80, Rest/binary>>, Z1,
    ...
    d_field_client_info_anonymous(Rest,
                                  ...
                                  F@_12,
                                  TrUserData);
dfp_read_field_def_client_info(<<90, Rest/binary>>, Z1,
                               Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                               F@_8, F@_9, F@_10, F@_11, F@_12, TrUserData) ->
    d_field_client_info_cn(Rest,
                           Z1,
                           Z2,
                           F@_1,
                           F@_2,
                           ...
                           F@_12,
                           TrUserData);
dfp_read_field_def_client_info(<<98, Rest/binary>>, Z1,
                               Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                               F@_8, F@_9, F@_10, F@_11, F@_12, TrUserData) ->
    d_field_client_info_dn(Rest,
                           Z1,
                           Z2,
                           F@_1,
                           F@_2,
...
dfp_read_field_def_client_info(<<>>, 0, 0, F@_1, F@_2,
    ...
    #{node => F@_1, clientid => F@_2, username => F@_3,
      ...
      is_superuser => F@_9, anonymous => F@_10, cn => F@_11,
      dn => F@_12};
...
d_field_client_info_anonymous(<<0:1, X:7, Rest/binary>>,
                              N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                              F@_8, F@_9, _, F@_11, F@_12, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc =/= 0,
                             TrUserData),
                          Rest},
    dfp_read_field_def_client_info(RestF,
...
d_field_client_info_cn(<<1:1, X:7, Rest/binary>>, N,
                       Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
                       F@_9, F@_10, F@_11, F@_12, TrUserData)
    when N < 57 ->
    d_field_client_info_cn(Rest,
                           ...
                           F@_12,
                           TrUserData);
d_field_client_info_cn(<<0:1, X:7, Rest/binary>>, N,
                       Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
                       F@_9, F@_10, _, F@_12, TrUserData) ->
    {NewFValue, RestF} = begin
                             Len = X bsl N + Acc,
                             <<Bytes:Len/binary, Rest2/binary>> = Rest,
                             {id(binary:copy(Bytes), TrUserData), Rest2}
...
d_field_client_info_dn(<<1:1, X:7, Rest/binary>>, N,
                       Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
                       F@_9, F@_10, F@_11, F@_12, TrUserData)
    when N < 57 ->
    d_field_client_info_dn(Rest,
                           ...
                           F@_12,
                           TrUserData);
d_field_client_info_dn(<<0:1, X:7, Rest/binary>>, N,
                       Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
                       F@_9, F@_10, F@_11, _, TrUserData) ->
    {NewFValue, RestF} = begin
                             Len = X bsl N + Acc,
                             <<Bytes:Len/binary, Rest2/binary>> = Rest,
                             {id(binary:copy(Bytes), TrUserData), Rest2}
...
'd_enum_valued_response.ResponsedType'(0) -> 'CONTINUE';
'd_enum_valued_response.ResponsedType'(1) -> 'IGNORE';
...
merge_msg_client_info(PMsg, NMsg, _) ->
    ...
    S12 = case {PMsg, NMsg} of
              {_, #{cn := NFcn}} -> S11#{cn => NFcn};
              {#{cn := PFcn}, _} -> S11#{cn => PFcn};
              _ -> S11
          end,
    case {PMsg, NMsg} of
        {_, #{dn := NFdn}} -> S12#{dn => NFdn};
        {#{dn := PFdn}, _} -> S12#{dn => PFdn};
        _ -> S12
    end.
...
v_msg_client_info(#{} = M, Path, TrUserData) ->
    ...
    case M of
        #{cn := F11} ->
            v_type_string(F11, [cn | Path], TrUserData);
        _ -> ok
    end,
    case M of
        #{dn := F12} ->
            v_type_string(F12, [dn | Path], TrUserData);
        _ -> ok
    end,
    lists:foreach(fun (node) -> ok;
                      (clientid) -> ok;
     ...
     {{msg, client_info},
      [#{name => node, fnum => 1, rnum => 2, type => string,
       ...
       #{name => anonymous, fnum => 10, rnum => 11,
         type => bool, occurrence => optional, opts => []},
       #{name => cn, fnum => 11, rnum => 12, type => string,
         occurrence => optional, opts => []},
       #{name => dn, fnum => 12, rnum => 13, type => string,
         occurrence => optional, opts => []}]},
     {{msg, message},
      [#{name => node, fnum => 1, rnum => 2, type => string,
         occurrence => optional, opts => []},
